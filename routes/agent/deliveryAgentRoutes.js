...
router.get('/earnings/history', authenticate, deliveryAgentController.getEarningsHistory);
...
router.patch('/online-status', authenticate, deliveryAgentController.updateOnlineStatus);
